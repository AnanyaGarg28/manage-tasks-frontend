...
export const Dashboard = () => {
  ...
  const todoProjects = projectsList.filter(
  ...
  return (
    <div className="flex flex-rows-2 bg-[#FEFEFE] divide-x-[1.5px] divide-[#F0F0F0]">
      <div className="mx-20 mt-14 w-[14%]">
        <div className="font-poppins font-medium text-[#161616] text-[20px] tracking-wide">
          .taskez
        </div>
        <div className="font-poppins font-normal text-[17px] text-[#9A9A9A]">
          <button className="mt-20 flex tracking-widest">
            <img
              src="./svg/Overview.svg"
              alt=""
              className="mr-7 inline-block self-center "
            />{" "}
            Overview
          </button>
          ...
          <button
            className="mt-10 flex tracking-widest hover:text-[#212121]"
            onClick={() => {
              dispatch(logOut());
            }}
          >
      ...
      <div className="grow px-16 pt-14 ">
        <div className="flex flex-row ">
          ...
          <div className="flex justify-end place-self-center w-1/3 font-poppins font-normal text-[17px] text-[#3A3A3A] tracking-widest">
            <div className="self-center"> Hi {user.userInfo.name}</div>
            <img
              src={user.userInfo.profileImage}
              alt=""
              className="ml-4 inline-block self-center h-11 w-11"
            />
          </div>
        </div>
        <div className="flex flex-row mt-16">
          <div className="font-poppins font-medium text-[24px] text-[#212121] grow">
            Projects
          </div>
        ...
        <div className="flex flex-row mt-8 font-poppins font-medium relative max-h-max">
          {expandProject && (
            <div className="absolute bg-white right-0 top-0 h-full w-[45%] pt-5 px-8 font-poppins shadow-lg">
              <div className="flex">
                <div className="font-medium text-[17px] text-[#212121] self-center grow">
                  {expandProject.title}
                </div>
                <IoIosClose
                  className="self-center h-8 w-8 hover:opacity-70 text-[#329C89]"
                  onClick={() => {
              ...
              <div className="mt-[60px] flex text-[12px]">
                <div className="font-normal text-[#6B6B6B] mr-9 self-center">
                  Created By
                </div>
                <div className="self-center flex">
                  <img
                    src={expandProject.authorInfo.profilePic}
                    alt=""
                    className="h-[25.26px] w-[25.26px] mr-3 self-center inline"
                  />
                  <div className="text-[#2E2E2E] font-normal self-center">
                    {expandProject.authorInfo.name}
                  </div>
                </div>
              </div>
              <div className="mt-[40px] flex font-normal text-[12px]">
                <div className="text-[#6B6B6B] self-center mr-9">
                  Description
                </div>
                <div className=" text-[#2E2E2E] self-center">
          ...
          <div className="bg-[#F5F9F9] w-[350px] mr-4 p-4 rounded-[15px]">
            <div className="flex">
              ...
              <div className="text-center text-[#329C89] bg-[#ECF3F3] rounded-[7px] w-6">
                {todoProjects.length}
              </div>
            </div>
            <button
              className="bg-[#ECF3F3] rounded-[7px] mt-5 w-full h-10"
              onClick={() => {
            ...
            {showProjectContainer === "todo" && (
              <ProjectContainer
                type="todo"
                setShowProjectContainer={setShowProjectContainer}
              />
            )}
            {todoProjects.map((project) => (
              <div
                className="bg-white px-[18.5px] py-[21.5px] font-poppins mt-6 rounded-lg w-full draggable"
                onClick={() => {
                  setExpandProject(expandProject ? null : project);
                }}
              >
                <div className="flex">
                  <div className="font-medium text-sm text-[#212121] grow">
                    {project.title}
                  </div>
                  <button
                    onClick={(e) => {
                ...
                <div className="font-normal text-xs text-[#6B6B6B] mt-2">
                  {project.description}
                </div>
                <div className="flex mt-6">
                  <img
                    src={project.authorInfo.profilePic}
                    className="h-7 w-7"
                    alt=""
                  />
                </div>
          ...
          <div className="bg-[#F5F9F9] w-[350px] mx-4 p-4 rounded-[15px]">
            <div className="flex">
              <div className=" text-[#212121] text-[16px] grow">
                In Progress
              </div>
              <div className="text-center text-[#329C89] bg-[#ECF3F3] rounded-[7px] w-6">
            ...
            <button
              ...
              onClick={() => {
                setShowProjectContainer(
                  showProjectContainer ? "" : "in progress"
                );
              }}
            >
              <img src="./svg/Plus.svg" alt="" className="w-4 h-4 mx-auto" />
            ...
            {inProgressProjects.map((project) => (
              <div
                className="bg-white px-[18.5px] py-[21.5px] font-poppins mt-6 rounded-lg w-full"
                onClick={() => {
                  setExpandProject(expandProject ? null : project);
                }}
              >
                ...
                <div className="font-normal text-xs text-[#6B6B6B] mt-4">
                  {project.description}
                </div>
                <div className="flex mt-6">
                  <img
          ...
          <div className="bg-[#F5F9F9] w-[350px] mx-4 p-4 rounded-[15px]">
            ...
            <button
              ...
              onClick={() => {
                setShowProjectContainer(
                  showProjectContainer ? "" : "completed"
                );
              }}
            >
              <img src="./svg/Plus.svg" alt="" className="w-4 h-4 mx-auto" />
